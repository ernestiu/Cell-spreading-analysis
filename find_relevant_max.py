...
relative criteria.
The input data is typically generated by the function
argrelextrema from spicy.signal that is applied on a 1D data set.

If no solution was found ind_max= -99 and ind_min = -99
is returned

 SYNOPSIS    ind_max, ind_min = find_relevant_max(i_max, val_max, i_min, val_min)
