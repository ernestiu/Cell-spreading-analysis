        ...
        for ii in range(cell.shape[0]): #going through individual slice of one single cell:
            ...
            if show_img:
                ...
                for acontour in img_edge:
                    ...
                    #plt.show()
            if flag = 0:
                print('Cell ' + str(kk+1) + '/' + str(cell_num) + ' Cell segmentation progress: ' + str(ii+1) + '/' + str(cell.shape[0]) + 'Segmentation method: Histogram minima')
            else:
                print('Cell ' + str(kk+1) + '/' + str(cell_num) + ' Cell segmentation progress: ' + str(ii+1) + '/' + str(cell.shape[0]) + 'Segmentation method: Triangle method')
